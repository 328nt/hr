        ...
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="admin/video/list">List video</a>
                        </li>
                        <li>
                            <a href="admin/video/create">Add VIdeo</a>
                        </li>
                    </ul>
                    <!-- /.nav-second-level -->
                </li>
                <li>
                    <a href="admin/member/list"><i class="fa fa-users fa-fw"></i>DANH SÁCH NHÂN VIÊN<span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="admin/member/list">Danh sách nhân viên</a>
                        </li>
                        <li>
                            <a href="admin/member/add">Thêm nhân viên</a>
                        </li>
                    </ul>
                    <!-- /.nav-second-level -->
                </li>
