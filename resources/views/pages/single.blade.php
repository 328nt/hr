	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav nav ml-auto">
	          ...
	          <li class="nav-item"><a href="index.html#practice-section" class="nav-link"><span>Practice Areas</span></a></li>
	          <li class="nav-item"><a href="index.html#attorneys-section" class="nav-link"><span>Attorneys</span></a></li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 ftco-animate">
            ...
            <p>
              <img src="upload/news/{{$news->image}}" alt="" class="img-fluid">
            </p>
          ...
          <div class="col-lg-4 sidebar ftco-animate">
            ...
            <div class="sidebar-box ftco-animate">
            	<h3 class="heading-sidebar">Categories {{count($catalogs)}} </h3>
              <ul class="categories">
                @foreach ($catalogs as $catalog)
                <li><a href="#">{{$catalog->name}} <span>({{count($catalog->new)}})</span></a></li>
                @endforeach
              </ul>
            </div>
            ...
            <div class="sidebar-box ftco-animate">
              ...
              <div class="block-21 mb-4 d-flex">
                ...
                <div class="text">
                  <h3 class="heading"><a href="news/{{$nc->id}}.html">{{$nc->title}}</a></h3>
                  <div class="meta">
