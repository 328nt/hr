    		...
    		<div class="row d-flex">
    			<div class="col-md-6 col-lg-6 d-flex order-md-last">
    				<div class="img-about img d-flex align-items-stretch">
	    				<div class="img d-flex align-self-stretch align-items-end" style="background-image:url(frontend/images/about.jpg);">
	    					<a href="https://www.youtube.com/watch?v=j8baN2yTJEw&list=RDj8baN2yTJEw&start_radio=1" class="icon-video popup-vimeo d-flex justify-content-center align-items-center mr-3">
    	...
    	<div class="container">
    		<div class="row d-flex">
    			<div class="col-md-6 col-lg-6 d-flex">
    				<div class="img-about img d-flex align-items-stretch">
	    				<div class="img d-flex align-self-stretch align-items-end" style="background-image:url(frontend/images/about-1.jpg);">
	    				</div>
    				</div>
    			</div>
    			<div class="col-md-6 col-lg-6 pl-lg-5 py-5">
		          ...
		          <div class="col-md-12 testimony-section">
								<div class="owl-carousel carousel-testimony">
				          		...
				          		<div class="d-flex">
				          			<div class="user-img img mr-3" style="background-image: url(frontend/images/person_1.jpg);"></div>
				          			<div>
			                    ...
			                    <span class="position">Businessman</span>
				          		...
				          		<div class="d-flex">
				          			<div class="user-img img mr-3" style="background-image: url(frontend/images/person_2.jpg);"></div>
				          			<div>
				          				<p class="name mb-0">Luis Fox</p>
			                    <span class="position">Businessman</span>
				          			</div>
				          		...
				          		<div class="d-flex">
				          			<div class="user-img img mr-3" style="background-image: url(frontend/images/person_3.jpg);"></div>
				          			<div>
				          				<p class="name mb-0">Luis Fox</p>
			                    <span class="position">Businessman</span>
				          			</div>
